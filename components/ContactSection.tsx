...
const ContactSection = () => {
  return (
    <section id="contact" className="bg-[#fcf9f8]">
      {/* CTA Banner */}
      <div className="max-w-[1280px] mx-auto px-6 md:px-16 mb-24">
        <motion.div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="space-y-6 text-[#41493f] text-sm">
              ...
              <div>
                <p className="font-bold text-[#0b4619] mb-2">Mills:</p>
                <p>Islampur, Horigari, Bogura-5800</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-bold text-[#002e0b] mb-6 whitespace-nowrap">Telephone & Mobile</h3>
            <div className="space-y-4 text-[#41493f] text-sm">
              <p><span className="font-bold text-[#0b4619]">Telephone:</span> 020589902530</p>
              <p><span className="font-bold text-[#0b4619]">Mobile:</span> 01711-412866</p>
            </div>
          </motion.div>
